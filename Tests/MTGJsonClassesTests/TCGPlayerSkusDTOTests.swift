...
struct TCGPlayerSkusDTOTests {
    ...
    func decodesSample() async throws {
        ...
        #expect(dto.meta.date == "2025-09-20")
        #expect(dto.meta.version == "5.2.2+20250920")
        
        #expect(dto.data.keys.contains("01359a41-06e6-5262-9fd0-ccad985803a0"))
        #expect(dto.data.keys.contains("00010d56-fe38-5e35-8aed-518019aa36a5"))
